        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="service-item">
              ...
              <h4>VPS Cloud</h4>
              <p>This site provides cloud services in downloading files, photos and videos It provides easy and flexible navigation to the site and the services it contains</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="service-item">
